...
export const techTabsData: TechTab[] = [
  {
    ...
    tools: [
      ...
      { name: "Asp.Net Core", icon: "/assets/Tech Stack Icons/csharp.svg" },
  ...
  },
  {
    ...
    tools: [
      ...
      { name: "Asp.Net", icon: "/assets/Tech Stack Icons/aspdotnet.svg" },
      { name: "Java", icon: "/assets/Tech Stack Icons/java.svg" },
  ...
  },
  {
    ...
    tools: [
      ...
      { name: "AWS", icon: "/assets/Tech Stack Icons/aws.svg" },
